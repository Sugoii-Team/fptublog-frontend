  ...
  const handleLecturerDataToUpdate = async (data) => {
    if (userProfile.role === "LECTURER") {
      try {
        ...
        const reponseProfile = await lecturerApi.updateLecturerProfile(
          userProfile.id,
          lectureInfo
        );
        ...
        const repsonseField = await lecturerApi.updateLecturerField(
          userProfile.id,
          fields
        );
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            ...
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <input
                ...
                type="text"
                {...register("firstName")}
                placeholder={lecturerUser.firstName}
              />
            ...
            <div className="w-full md:w-1/2 px-3">
              ...
              <input
                ...
                type="text"
                {...register("lastName")}
                placeholder={lecturerUser.lastName}
              />
            </div>
          </div>
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">
              ...
              <input
                ...
                placeholder={lecturerUser.email}
                disabled={true}
              />
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">
              ...
              <input
                ...
                placeholder={lecturerUser.alternativeEmail}
              />
              <p className="text-red-500 text-xs italic">
