...
function Profile(props) {
  ...
  const handleTakeStudentInformation = async (id) => {
    ...
    const studentMajor = await userApi.getStudentMajorByMajorId(
      student.data.majorId
    );
    ...
    <div className="my-24 w-11/12 relative mx-auto h-full">
      ...
      >
        {loading ? (
          ...
          <div
            className="profileHeader border-2 border-gray-100 rounded-lg h-40 grid grid-cols-6 mt-5 shadow-lg"
            onLoad={
              userProfile.role === "STUDENT"
                ? () => handleTakeStudentInformation(userProfile.id)
                : () => handleTakeLecturerInformation(userProfile.id)
            }
          >
            ...
            <form onSubmit={handleSubmit(onHandleSubmit)}>
              ...
              <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full px-3">
                  ...
                  <input
                    className="h-11 appearance-none block w-full bg-gray-100 text-gray-600 border border-gray-100 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
              ...
              <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full px-3">
                  ...
                  <input
                    ...
                    placeholder={userProfile.alternativeEmail}
                  />
                  <p className="text-red-500 text-xs italic">
                    Please check this infomation carefully before update !
                  </p>
                </div>
              </div>
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                  <div className="w-full px-3">
                    ...
                    <input
                      className="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-100 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                      {...register("schoolYear")}
                      placeholder={studentUser.schoolYear}
                    />
                  </div>
                  <div className="w-full px-3">
                    <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
              ...
              >
                ...
                <div className="my-8">
                  <Link
                    ...
                    className="font-bold text-xl ml-4 uppercase"
                  >
                    {popularBlog.title}
                  </Link>
